...
function ExpertEditProfile() {
  ...
  return (
    <div>
      <Button className="w-28 bg-pink-900" onClick={handleOpen}>
        Edit
      </Button>
        ...
        <form onSubmit={handleSubmit}>
          <div className="flex items-center justify-between">
            <DialogHeader className="flex flex-col items-start">
              {" "}
              <Typography
                className="mb-1 font-serif text-indigo-900"
                variant="h4"
              >
                EDIT PROFILE
              </Typography>
          ...
          <DialogBody>
            <div className="grid gap-6">
              ...
              <div className="w-full"><Textarea label="Description" name="description" onChange={handleChange}
                  onBlur={handleBlur}
